...
def download_chromedriver(path: Optional[AnyStr] = None, no_ssl: bool = False, make_version_dir: bool = True):
    """
...
if __name__ == "__main__":
    ...
    print(download_chromedriver(no_ssl=False, make_version_dir=False))